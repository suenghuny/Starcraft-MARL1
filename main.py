...
def train(agent, env, e, t, train_start, epsilon, min_epsilon, anneal_epsilon, initializer, output_dir, model_save_freq):
...
def main():
    ...
    if vessl_on == True:
        output_dir = "/output/map_name_{}_GNN_{}_lr_{}_hiddensizeobs_{}_hiddensizecomm_{}_hiddensizeq_{}_nrepresentationobs_{}_nrepresentationcomm_{}/".format(map_name1, GNN, learning_rate, hidden_size_obs, hidden_size_comm, hidden_size_Q, n_representation_obs, n_representation_comm)
    else:
        output_dir = "../output/map_name_{}_GNN_{}_lr_{}_hiddensizeobs_{}_hiddensizecomm_{}_hiddensizeq_{}_nrepresentationobs_{}_nrepresentationcomm_{}/".format(
            map_name1, GNN, learning_rate, hidden_size_obs, hidden_size_comm, hidden_size_Q, n_representation_obs, n_representation_comm)
