...
class Agent:
    ...
    def load_model(self, path):
        ...
        self.node_representation_enemy_obs.load_state_dict(checkpoint["node_representation_enemy_obs"])
        self.node_representation.load_state_dict(checkpoint["node_representation"])

        self.action_representation.load_state_dict(checkpoint["action_representation"])

        self.func_enemy_obs.load_state_dict(checkpoint["func_enemy_obs"])
        self.func_ally_comm.load_state_dict(checkpoint["func_ally_comm"])
