...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_comm", type=int, default=64, help="")
    parser.add_argument("--hidden_size_Q", type=int, default=96, help="GTN 해당")
    parser.add_argument("--hidden_size_meta_path", type=int, default=42, help="GTN 해당")
    parser.add_argument("--n_representation_obs", type=int, default=32, help="GTN 해당")
    parser.add_argument("--n_representation_comm", type=int, default=64, help="")
    ...
    parser.add_argument("--load_path", type=str, default="/30000.pt", help="loadpath")
    parser.add_argument("--model_save_freq", type=int, default=50000, help="model save frequency")
    print("cfg")
